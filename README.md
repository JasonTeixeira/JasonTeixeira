...
<p>Projects are essential for gaining practical experience. When I began learning cloud technologies, I understood that it wasn't enough to simply learn how a service functions—I needed to see how it fits into a larger, real-world context. Coming from a business background, I fundamentally recognize that technology serves the business, not the other way around. This principle naturally leads to designing systems with simplicity and efficiency in mind. In an enterprise environment, every configuration change introduces a host of considerations—often a thousand or more—that must be carefully weighed.</p>

<p>The approach I’ve taken with my public projects mirrors how I would approach a real-world scenario: starting with the business requirements. These include understanding how the business operates, identifying its technology needs, managing customer data in compliance with industry standards, ensuring security, planning for scalability to millions of users, and devising a robust disaster recovery strategy. As you can imagine, the list of considerations is extensive.</p>

<p>At a senior level, most architects' detailed system designs are proprietary, with the majority governed by internal agreements. Why mention this? Because building a system from scratch is a highly specialized task, and while many systems share common components, no two are exactly alike—each business has its unique requirements. This is why new hires often spend their initial months familiarizing themselves with the company’s architectural and technical documentation.</p>

<p>I am continuously developing private repositories, and they will be released as they become applicable for real-world use. My aim has always been to craft each project in a business setting, with a focus on meeting the business’s needs first. One challenge, however, lies in documenting these systems in a universally accepted framework—such a standard doesn’t exist. Each company tends to document its systems slightly differently. For consistency, I have adopted the TOGAF framework, which I believe provides both structure and flexibility for various inputs.</p>

<p>For every project I publish, I aim to go beyond the technical deliverables by including an extensive list of critical considerations. These common themes are organized into categories and evaluated based on a range of factors. My goal is for anyone engaging with my projects—whether recreationally or professionally—to understand that these considerations are always top of mind, even if they are not explicitly documented.</p>
